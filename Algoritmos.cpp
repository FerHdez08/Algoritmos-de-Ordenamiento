...
int main() {
    ...
    for (int i = 0; i < VECES; i++) {
        ...
        for (int m = 0; m < NUM_ALGORITMOS; ++m) {
            ...
            //Aplicar un método para cada uno de los conjuntos de diferentes tamaños
            for (int j = 0; j <= (TAM_MAXIMO - TAM_MINIMO) / INCREMENTO; ++j) {
                int K = (j + 1) * 10;
...
//*****************************************************************************************************************
//Función tilizada para llenar de números aleatorios los conjuntos de todos los tamaños
int aleatorio(int inicio, int fin)
{
    return inicio + rand()% (fin-inicio+1);
}
//*****************************************************************************************************************
//FUnción para intercambiar elementos de un arreglo
void swap(int *a, int *b) {
    int temp = *a;
    *a = *b;
    *b = temp;
...
//*****************************************************************************************************************
//Función encargada de generar una copia para cada uno de los conjuntos generados, para cada uno de los ordenamientos
